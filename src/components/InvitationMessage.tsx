...
Let's make your birthday unforgettable. Are you ready?
    ...
    <div className="my-8 w-full max-w-2xl px-4 mx-auto">
      ...
      >
        ...
        <button
          ...
          aria-label={`${isOpen ? "Hide" : "View"} invitation message`}
          className="w-full flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-rose-400 to-pink-500 px-6 py-4 font-bold text-white shadow-lg hover:shadow-xl transition-all duration-300 active:scale-[0.98] min-h-[48px] focus:outline-none focus:ring-2 focus:ring-rose-400"
        >
          <Mail size={20} className="shrink-0" />
          <span>{isOpen ? "Hide" : "View"} Invitation Message</span>
          <Heart size={16} fill="white" className="shrink-0 text-white" />
        </button>
          ...
          {isOpen && (
            ...
            >
              ...
              <div className="relative z-10 text-center mb-4">
                <h3 className="text-xl font-bold text-rose-600 font-display flex items-center justify-center gap-2">
              ...
              <div className="relative z-10 flex justify-center mt-4">
                <button
                  onClick={handleCopy}
                  aria-label="Copy invitation message text"
                  className={`flex items-center gap-2 rounded-full px-6 py-2.5 font-bold text-white shadow-md transition-all duration-300 min-h-[44px] active:scale-95 focus:outline-none focus:ring-2 focus:ring-rose-400 ${
                    copied
